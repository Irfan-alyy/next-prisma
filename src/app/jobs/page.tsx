...
import { Search, Briefcase, MapPin, DollarSign } from 'lucide-react'; // Importing icons from lucide-react
import { motion } from 'framer-motion'; // Importing framer-motion for animations

// Sample job data (replace with actual data fetching logic in a real app)
const sampleJobs = [
  {
    id: 1,
